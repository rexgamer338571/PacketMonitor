...
public class Monitor {
    ...
    public Monitor() {
        frame = new JFrame("Packet Monitor (Fabric)");
        ...
        frame.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosed(WindowEvent e) {
                ...
                PacketMonitor.MONITORS.remove(Monitor.this);
                PacketMonitor.PACKETS.clear();
            }
        });
    ...
    public void notifyMonitor() {
        ...
        for (PacketWrapper packetWrapper : PacketMonitor.PACKETS) {
